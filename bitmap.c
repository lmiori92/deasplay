...
const uint8_t font5x8[] BITMAP_STORAGE_FLAGS =
{
    //- - - - - - -  STANDARD ASCII  (7bits)  - - - - - - -//
    //      8 byte wide codes                 ASCII val(dec) --> ASCII CODE
    ...
    0x00,0x3C,0x42,0x41,0x42,0x3C,0x00,0x00, //128/ --> Ä
    0x00,0x30,0x28,0x60,0xA0,0x60,0x28,0x30, //129/ --> Å
    0x20,0x20,0x20,0x20,0xA0,0x20,0x28,0x30, //130/ --> Ç
    0x20,0x20,0x20,0x20,0xB0,0x20,0x20,0x20, //131/ --> É
    0x00,0x30,0x28,0x20,0xA0,0x20,0x30,0x20, //132/ --> Ñ
    0x20,0x20,0x20,0x22,0x20,0x22,0x28,0x30, //133/ --> Ö
    0x20,0x20,0x20,0x22,0x30,0x22,0x20,0x20, //134/ --> Ü
    0x00,0x30,0x28,0x22,0x20,0x22,0x30,0x20, //135/ --> á
    0x20,0x20,0x20,0x22,0x21,0x22,0x28,0x30, //136/ --> à
    0x20,0x20,0x20,0x22,0x31,0x22,0x20,0x20, //137/ --> â
    0x00,0x30,0x28,0x22,0x21,0x22,0x30,0x20, //138/ --> ä
    0x20,0x20,0x28,0x28,0x28,0xB0,0x20,0x20, //139/ --> ã
    0x20,0x20,0x28,0x28,0x28,0x30,0x20,0x20, //140/ --> å
    0x00,0xC0,0xA8,0x28,0x68,0xB0,0x60,0x20, //141/ --> ç
    0x00,0x00,0x80,0x80,0x44,0x32,0x04,0x00, //142/ --> é
    0x00,0x24,0x25,0x24,0x38,0x20,0x20,0x20, //143/ --> è
    0x30,0x24,0x22,0x21,0x24,0x2A,0x11,0x00, //144/ --> ê
    0x00,0x80,0x80,0x40,0x34,0x20,0x20,0x20, //145/ --> ë
    0x20,0x20,0x20,0x38,0x20,0x38,0x20,0x18, //146/ --> í
    0x20,0x20,0x38,0x20,0x38,0x20,0x38,0x20, //147/ --> ì
    0x60,0x80,0x80,0x78,0x20,0x38,0x20,0x18, //148/ --> î
    0x20,0x20,0x20,0x38,0x22,0x39,0x22,0x18, //149/ --> ï
    0x20,0x20,0x38,0x22,0x39,0x22,0x38,0x20, //150/ --> ñ
    0x60,0x80,0x80,0x78,0x22,0x39,0x22,0x18, //151/ --> ó
    0x30,0x20,0x20,0x20,0x24,0x2A,0x11,0x00, //152/ --> ò
    0x20,0x30,0x20,0x30,0x28,0x28,0x38,0x20, //153/ --> ô
    0x60,0x80,0x80,0x60,0x30,0x28,0x28,0x38, //154/ --> ö
    0x20,0x20,0x30,0x20,0x30,0x28,0x2A,0x18, //155/ --> õ
    0x20,0x30,0x20,0x30,0x28,0x2A,0x38,0x20, //156/ --> ú
    0x60,0x80,0x80,0x60,0x30,0x28,0x2A,0x38, //157/ --> ù
    0x20,0x20,0x3E,0x30,0x28,0x28,0x38,0x20, //158/ --> û
    0x20,0x20,0x3E,0x30,0x28,0x2A,0x38,0x20, //159/ --> ü
    ...
    0x20,0x20,0x30,0x28,0x2A,0x30,0x20,0x20, //167/ --> ß
    ...
    0x30,0x28,0x2C,0x2A,0x20,0x3F,0x20,0x20, //174/ --> Æ
    0x20,0x20,0x20,0x20,0x20,0x20,0x1F,0x00, //175/ --> Ø
    ...
    0x20,0x20,0x30,0x28,0x3A,0x2C,0x38,0x20, //185/ --> π
    0x00,0x18,0x14,0x14,0x18,0x20,0x20,0x20, //186/ --> ∫
    0x00,0x21,0x22,0x24,0x28,0x10,0x0F,0x00, //187/ --> ª
    0x00,0xB0,0xA8,0x78,0x20,0x20,0x20,0x20, //188/ --> º
    0x20,0x20,0x20,0xA0,0x20,0xA0,0x28,0x30, //189/ --> Ω
    0x20,0x20,0x20,0xA0,0x30,0xA0,0x20,0x20, //190/ --> æ
    0x00,0x60,0x80,0x80,0xA0,0x50,0x10,0x20, //191/ --> ø
    ...
    0x00,0x00,0x04,0xB6,0xAD,0x7D,0x04,0x00, //196/ --> ƒ
    ...
    0x00,0x30,0x28,0x22,0x21,0x22,0x28,0x30, //203/ --> À
    0x00,0xC0,0xA8,0xA8,0x28,0xB0,0x20,0x20, //204/ --> Ã
    0x00,0xC0,0xA8,0xA8,0xA8,0x30,0x20,0x20, //205/ --> Õ
    0x00,0xC0,0xA8,0xAA,0x28,0x30,0x20,0x20, //206/ --> Œ
    0x00,0x00,0x24,0x24,0x24,0x38,0x00,0x00, //207/ --> œ
    ...
    0x20,0x20,0x3E,0x30,0x28,0x28,0x18,0x00, //216/ --> ÿ
    0x20,0x20,0x3E,0x30,0x28,0x2A,0x18,0x00, //217/ --> Ÿ
    ...
    0x00,0x60,0x80,0x80,0xB2,0xA8,0x7A,0x00, //222/ --> ﬁ
    0x00,0x30,0x28,0x2C,0x2A,0x20,0x3F,0x00, //223/ --> ﬂ
    ...
    0x00,0x00,0x30,0x28,0x28,0x30,0x00,0x00, //229/ --> Â
    0x00,0x00,0x00,0xB0,0xA8,0x78,0x00,0x00, //230/ --> Ê
    0x04,0x26,0x25,0x25,0x28,0x10,0x0F,0x00, //231/ --> Á
    0x04,0x22,0x22,0x26,0x29,0x10,0x0F,0x00, //232/ --> Ë
    0x00,0x21,0x22,0x24,0xA8,0xD0,0xAF,0xA0, //233/ --> È
    0x00,0x70,0xAA,0xA9,0xAA,0x30,0x00,0x00, //234/ --> Í
    0x00,0x70,0xAA,0xA8,0xAA,0x30,0x00,0x00, //235/ --> Î
    0x00,0x30,0x40,0x40,0x50,0x28,0x08,0x00, //236/ --> Ï
    0x00,0x30,0xC0,0x40,0xD0,0x28,0x08,0x00, //237/ --> Ì
    0x00,0x00,0x02,0x79,0x02,0x00,0x00,0x00, //238/ --> Ó
    0x00,0x00,0x02,0x78,0x02,0x00,0x00,0x00, //239/ --> Ô
    0x00,0x00,0x00,0x00,0x00,0x05,0x05,0x05, //240/ --> 
    0x00,0x00,0x00,0x04,0x03,0x0B,0x06,0x06, //241/ --> Ò
    0xA0,0xA0,0xA0,0x00,0x00,0x00,0x00,0x00, //242/ --> Ú
    0x00,0x00,0x01,0x01,0x01,0x01,0x00,0x00, //243/ --> Û
    0x00,0x21,0x22,0x24,0x28,0x10,0x2F,0x20, //244/ --> Ù
    0x00,0x00,0x00,0x00,0x00,0x04,0x03,0x03, //245/ --> ı
    0x00,0x00,0x80,0x80,0x80,0x80,0x00,0x00, //246/ --> ˆ
    ...
    0x00,0x40,0x60,0x50,0x48,0x50,0x40,0x40 //255/ --> ˇ
};

// maybe set it as inline and place it in the .h file...
void bitmap_character(char chr, uint8_t *destination, uint8_t len_max, e_font font)
{
    ...
    {
#ifdef __AVR
        memcpy_P(destination, font5x8 + (chr * 8U), size);
#else
    /* other generic C platforms */
    memcpy(destination, font5x8 + (chr * 8U), size);
#endif
    }
}
