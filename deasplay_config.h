...
//#define DEASPLAY_SSD1036
#define DEASPLAY_HD44780

/* Configure the number of lines and the number of character
 * the specific implementation has to drive. */
//#define DEASPLAY_LINES       (32U)      /**< Bitmapped display horizontal size, pixels or textual lines for char display */
//#define DEASPLAY_CHARS       (128U)     /**< Bitmapped display vertical size, pixels or characters per line for char display */

#define DEASPLAY_LINES 2
